...
class DnsmasqService(DhcpServerService):
    ...
    def __init__(self, dependencies: ServiceDependencies, system_bus: SystemBus, config: DnsmasqConfig,
                 resource_root: str,
                 template_file: str = 'config/dnsmasq.conf.template',
                 config_file: str = '/etc/dnsmasq.conf') -> None:
    ...
    def _setup_config(self) -> None:
        ...
        write_file(self._config_file, self._config_file_content)
